...
return view(
    'auth.'.get_setting('authentication_layout_select').'.reset_password',
    ['email' => $user->email]           // <-- make it available in the view
)->with('reset_email', $user->email);    // <-- also put it in session (fallback)
