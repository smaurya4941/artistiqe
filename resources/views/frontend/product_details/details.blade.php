...
<h2 class="mb-4 text-dark" 
    style="font: 700 26px/1.2 system-ui, -apple-system, 'Segoe UI', Roboto, Arial, sans-serif;">
    ...
    <div class="row align-items-center mb-3">
        ...
        @endif--->
        <!-- Estimate Shipping Time (static 7 days for every single product page) -->
        <div class="col-auto fs-14 mt-1">
        <small class="mr-1 opacity-50 fs-14">{{ translate('Estimate Shipping Time') }}:</small>
             <span class="fw-500">7 {{ translate('Days') }}</span>
             </div>
               ...
               @if ($detailedProduct->auction_product != 1)
                   ...
                   <!-- Add to wishlist button -->
                    ...
                    onclick="toggleWishlist(this, {{ $detailedProduct->id }})"
                     class="mr-3 fs-14 text-dark opacity-60 has-transitiuon hov-opacity-100 wishlist-btn">
                          <i class="la la-heart-o mr-1"></i>
                               {{ translate('Add to Wishlist') }}
                          </a>
                         </div>
    ...
    // Call your existing wishlist function
    ...
    if (icon.classList.contains("la-heart-o")) {
        ...
        icon.classList.add("wishlist-active"); // makes it red
    } else {
        icon.classList.remove("la-heart", "wishlist-active");
    ...
    @if ($detailedProduct->brand != null)
        <div class="d-flex flex-wrap align-items-center mb-3">
            <span class="fs-14 fw-400 mr-4 w-80px" style="color:#000;">{{ translate('Brand') }}</span><br>
    ...
    @if ($detailedProduct->has_warranty == 1 && $detailedProduct->warranty_id != null)
        <div class="d-flex flex-wrap align-items-center mb-3">
                ...
                <span class="fs-14 fw-400 mr-4 w-80px" style="color:#000;">{{ translate('Warranty') }}</span><br>
            ...
            <span class="border border-secondary-base btn fs-12 ml-3 px-3 py-1 rounded-1 text-secondary">
                ...
                @if($detailedProduct->warranty_note_id != null)
                    <span href="javascript:void(1);" 
                        ...
                        class="border-bottom border-bottom-4 ml-2 >
    ...
    <!--<div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4">
            ...
            @if ($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation') == 1)
                  <span class="fs-14 fw-500 mr-4 w-80px" style="color:#000;">{{ translate('Sold by') }}</span>
    ...
    @if ($detailedProduct->auction_product)
        <div class="row no-gutters mb-3">
            <div class="col-sm-2">
                   <div class="fs-14 fw-400 mt-1" style="color:#000;">>{{ translate('Auction Will End') }}</div>
            </div>
            <div class="col-sm-10">
        ...
        <div class="row no-gutters mb-3">
            <div class="col-sm-2">
                   <div class="fs-14 fw-400 mt-1" style="color:#000;">{{ translate('Starting Bid') }}</div>
            </div>
            <div class="col-sm-10">
        ...
        @if (Auth::check() &&
            ...
            <div class="row no-gutters mb-3">
                <div class="col-sm-2">
                       <div class="fs-14 fw-400 mt-1" style="color:#000;">{{ translate('My Bidded Amount') }}</div>
                </div>
                <div class="col-sm-10">
                    <span class="opacity-50 fs-20">
        ...
        <div class="row no-gutters my-2 mb-3">
            <div class="col-sm-2">
                   <div class="fs-14 fw-400 mt-1" style="color:#000;">{{ translate('Highest Bid') }}</div>
            </div>
            <div class="col-sm-10">
    ...
    @else
        ...
        @else
            ...
            @if (home_price($detailedProduct) != home_discounted_price($detailedProduct))
                <div class="row no-gutters mb-3">
                    <div class="col-sm-2">
                          <div class="fs-14 fw-500 mt-2" style="color:#000;">{{ translate('Price') }}</div>
                    </div>
                    <div class="col-sm-10">
                        <div class="d-flex align-items-center">
                            ...
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                                <div class="ml-2 bg-secondary-base d-flex justify-content-center align-items-center px-3 py-1"
                                    ...
                                    <small class="fs-11 fw-500 ml-2"style="color:#000;">{{ translate('Club Point') }}:
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            @if ($detailedProduct->digital == 0)
                ...
                @if ($detailedProduct->choice_options != null)
                    @foreach (json_decode($detailedProduct->choice_options) as $key => $choice)
                        <div class="row no-gutters mb-3">
                            <div class="col-sm-2">
                            <div class="fs-14 fw-500 mt-2" style="color:#000;">
                ...
                @if ($detailedProduct->colors != null && count(json_decode($detailedProduct->colors)) > 0)
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
                              <div class="fs-14 fw-500 mt-2" style="color:#000;">{{ translate('Color') }}</div>
                        </div>
                        <div class="col-sm-10">
                            <div class="aiz-radio-inline">
                ...
                <div class="row no-gutters mb-3">
                    <div class="col-sm-2">
                         <div class="fs-14 fw-500 mt-2" style="color:#000;">{{ translate('Quantity') }}</div>
                    </div>
            ...
            <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                <div class="col-sm-2">
                       <div class="fs-14 fw-500 mt-2" style="color:#000;">{{ translate('Total Price') }}</div>
                </div>
                <div class="col-sm-10">
                    <div class="product-price">
                        <strong id="chosen_price" class="fs-16 fw-700 text-primary">
    ...
    {{ translate('Buy Now') }} <i class="la la-long-arrow-right"></i>
        ...
        @if (addon_is_activated('refund_request'))
            <div class="row no-gutters mt-3">
                <div class="col-sm-2">
                     <div class="fs-14 fw-400 mt-2" style="color:#000;">{{ translate('Refund') }}</div>
                </div>
                <div class="col-sm-10">
        ...
        @if ($detailedProduct->digital == 1)
            @if ($detailedProduct->added_by == 'seller')
                <div class="row no-gutters mt-3">
                    <div class="col-2">
                           <div class="fs-14 fw-500 mt-2" style="color:#000;">{{ translate('Seller Guarantees') }}</div>
                    </div>
                    <div class="col-10">
    ...
    <div class="row no-gutters mt-4">
        <div class="col-sm-2">
            <div class="fs-14 fw-400 mt-2" style="color:#000;">
    {{ translate('Share') }}
            </div>
        </div>
    </div>
...
<!--<div class="bg-white border mb-4">
    <div class="p-3 p-sm-4">
        <h5 class="fs-16 fw-700 mb-0">
            <span class="mr-4">{{ translate('Shipping : Artistiqe') }}</span>
        </h5>
           <P style="font-size:1rem;">
<br><b>Delivery by Artivine Consulting (Artistiqe):</b><br>
Your artwork is shipped securely through Artivine Consulting (Artistiqe), from pickup to final delivery.<br>
<b>Worldwide Delivery (Domestic 0–7 Days & International 0–15 Days):</b><br>
Reliable domestic and international shipping with comprehensive tracking, ensuring your artwork is delivered safely. A tracking number will be provided for real-time monitoring.<br>
<b>Secure & Insured Shipping:</b><br>
Artworks are shipped with premium carriers, securely packaged, and fully insured.<br>
<b>Customs & Duties:</b><br>
Customs fees are excluded. Most countries exempt original artworks from import taxes, though reduced VAT may apply. Any charges will be assessed by local customs and billed by the carrier.
</P>
