            ...
            <div class="bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                      ...
                      @include('frontend.product_details.shipping_artistiqe')

                        
                        <!-- Top Selling Products -->
                        @include('frontend.product_details.top_selling_productsgrid2')
                             
                       <!-- top_sellers_grid -->
                        @include('frontend.product_details.top_sellers_grid')
