...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('assets/slick/slick.css') }}"/>
    <link rel="stylesheet" href="{{ static_asset('assets/slick/slick-theme.css') }}"/>
    <link rel="stylesheet" href="{{ static_asset('assets/css/custom-design.css?v=') }}{{ rand(1000, 9999) }}">
    ...
    <style>
        :root{
            ...
            --dark: #292933;
            --soft-dark: #1b1b28;
            --primary: {{ get_setting('base_color', '#0378ab') }};
