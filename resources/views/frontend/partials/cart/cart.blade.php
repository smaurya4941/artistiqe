...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100 {{ count($carts) > 0 ? 'cart-has-items' : '' }}" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <span class="mr-2 position-relative d-inline-block">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20.562" viewBox="0 0 24 20.562">
            <g id="_5e67fc94b53aaec8ca181b806dd815ee" data-name="5e67fc94b53aaec8ca181b806dd815ee" transform="translate(-33.276 -101)">
              <path id="Path_32659" data-name="Path 32659" d="M34.034,102.519H38.2l-.732-.557c.122.37.243.739.365,1.112q.441,1.333.879,2.666.528,1.6,1.058,3.211.46,1.394.917,2.788c.149.451.291.9.446,1.352l.008.02a.76.76,0,0,0,1.466-.4c-.122-.37-.243-.739-.365-1.112q-.441-1.333-.879-2.666-.528-1.607-1.058-3.213-.46-1.394-.917-2.788c-.149-.451-.289-.9-.446-1.352l-.008-.02a.783.783,0,0,0-.732-.557H34.037a.76.76,0,0,0,0,1.519Z" fill="#000"/>
              <path id="Path_32660" data-name="Path 32660" d="M288.931,541.934q-.615,1.1-1.233,2.193c-.058.106-.119.21-.177.317a.767.767,0,0,0,.656,1.142h11.6c.534,0,1.071.01,1.608,0h.023a.76.76,0,0,0,0-1.519h-11.6c-.534,0-1.074-.015-1.608,0h-.023l.656,1.142q.615-1.1,1.233-2.193c.058-.106.119-.21.177-.316a.759.759,0,0,0-1.312-.765Z" transform="translate(-247.711 -429.41)" fill="#000"/>
              <circle id="Ellipse_553" data-name="Ellipse 553" cx="1.724" cy="1.724" r="1.724" transform="translate(49.612 117.606)" fill="#000"/>
              ...
              <circle id="Ellipse_554" data-name="Ellipse 554" cx="1.724" cy="1.724" r="1.724" transform="translate(40.884 117.606)" fill="#000"/>
              ...
              <path id="Path_32663" data-name="Path 32663" d="M267.044,237.988q-.52,1.341-1.038,2.682-.828,2.138-1.654,4.274l-.38.983.489-.372H254.1c-.476,0-.957-.02-1.436,0h-.02l.489.372q-.444-1.348-.886-2.694-.7-2.131-1.4-4.264c-.109-.327-.215-.653-.324-.983l-.489.641h16.791c.228,0,.456.005.681,0h.03a.506.506,0,0,0,0-1.013H250.744c-.228,0-.456-.005-.681,0h-.03a.511.511,0,0,0-.489.641q.444,1.348.886,2.694.7,2.131,1.4,4.264c.109.327.215.653.324.983a.523.523,0,0,0,.489.372h10.359c.476,0,.957.018,1.436,0h.02a.526.526,0,0,0,.489-.372q.52-1.341,1.038-2.682.828-2.138,1.654-4.274l.38-.983a.508.508,0,0,0-.355-.623A.52.52,0,0,0,267.044,237.988Z" transform="translate(-210.769 -133.152)" fill="#000"/>
            </g>
        </svg>
        
    
     @if(count($carts) > 0)
      <span class="cart-badge cart-badge-primary badge-inline badge-pill absolute-top-right--10px">
        {{count($carts) }}
      </span>
       @endif
      </span>
...
<!-- Cart button with cart count -->
<style>
/* CART ICON — red only (scoped to .cart-icon so it won't touch the badge) */
a[title="Cart"].cart-has-items .cart-icon svg,
a[title="Cart"].cart-has-items .cart-icon svg * {
  fill: #e62e04; !important;
  stroke: #e62e04; !important;
...
/* (Optional catch-alls for inline fills) */
a[title="Cart"].cart-has-items .cart-icon svg [fill],
a[title="Cart"].cart-has-items .cart-icon svg [style*="fill"],
a[title="Cart"].cart-has-items .cart-icon svg [fill="none"] {
  fill: #e62e04; !important;
  stroke: #e62e04; !important;
}

/* BADGE — always black (place AFTER any other badge rules) */
a[title="Cart"] .cart-badge,
a[title="Cart"] .cart-badge * {
                        ...
                        <span class="d-flex align-items-center">
                            <a href="{{ route('product', $product->slug) }}"
                                ...
                                <span class="minw-0 pl-2 flex-grow-1">
                                    ...
                                    <span class="fs-14 fw-400 text-dark">{{ $cartItem['quantity'] }}x</span>
                            ...
                            <span class="">
                                <button onclick="removeFromCart({{ $cartItem['id'] }})"
                                    ...
                                    <i class="la la-close fs-18 fw-600 text-dark"></i>
                                </button>
                            </span>
                        </span>
                    </li>
