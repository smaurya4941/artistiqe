    ...
    <div class="container text-center">
        <div class="row">
            <!--<div class="col-lg-6 text-center text-lg-left">
             ...
             <div class="col-lg-6 custom-terms-heading">
    <h1 class="terms-title">{{ $page->getTranslation('title') }}</h1>
</div>
            <div class="col-lg-6">
...
<section class="mb-4">
    <div class="container">
        <div class="p-4 bg-white rounded shadow-sm overflow-hidden mw-100 text-left cms-content">
            @php
