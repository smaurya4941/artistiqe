...
@section('content')
  ...
  <li class="nav-item">
    <a class="nav-link active inhouse_top_categories" id="cat-all-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="all" type="button" role="tab"
       aria-controls="cat-all" aria-selected="true">{{ translate('All') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_categories" id="cat-today-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="DAY" type="button" role="tab"
       aria-controls="cat-today" aria-selected="false">{{ translate('Today') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_categories" id="cat-week-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="WEEK" type="button" role="tab"
       aria-controls="cat-week" aria-selected="false">{{ translate('Week') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_categories" id="cat-month-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="MONTH" type="button" role="tab"
       aria-controls="cat-month" aria-selected="false">{{ translate('Month') }}</a>
  </li>
</ul>
  ...
  <li class="nav-item">
    <a class="nav-link active inhouse_top_brands" id="brand-all-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="all" type="button" role="tab"
       aria-controls="brand-all" aria-selected="true">{{ translate('All') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_brands" id="brand-today-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="DAY" type="button" role="tab"
       aria-controls="brand-today" aria-selected="false">{{ translate('Today') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_brands" id="brand-week-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="WEEK" type="button" role="tab"
       aria-controls="brand-week" aria-selected="false">{{ translate('Week') }}</a>
  </li>
  <li class="nav-item">
    <a class="nav-link inhouse_top_brands" id="brand-month-tab" href="javascript:void(0)"
       data-toggle="tab" data-target="MONTH" type="button" role="tab"
       aria-controls="brand-month" aria-selected="false">{{ translate('Month') }}</a>
  </li>
</ul>
...
@endsection
<style>
    /* keep each header + tabs layer clean */
.dashboard-box .px-2rem { position: relative; z-index: 2; background: #fff; }
.dashboard-tab { position: relative; z-index: 1; }
.h-40px { line-height: 1.3; } /* avoid tight line-height wrapping on headings */
/* Allow multi-line titles without overlap */
.dashboard-box .h-40px {
  height: auto !important;     /* was fixed 40px */
  min-height: 40px;            /* keeps layout when single line */
  line-height: 1.3;            /* better readability */
}

/* Give a little breathing room before tabs */
.dashboard-box .px-2rem + .nav {
  margin-top: .25rem;
}
