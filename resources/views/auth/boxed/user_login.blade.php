...
@section('content')
    ...
    <style>
.login-page-bg {
    background: url("{{ static_asset('assets/img/loginbg.svg') }}") repeat;
    min-height: 100vh;
    display: flex;
    align-items: center;
...
@media (max-width: 992px) {
    .login-row {
        flex-wrap: wrap; /* only tablet/mobile */
    }
}
...
<div class="col d-flex align-items-center position-absolute" style="top:20px; left:20px; z-index:10;">
        <a href="{{ route('home') }}">
            @php $header_logo = get_setting('header_logo'); @endphp
            @if ($header_logo)
                <img src="{{ uploaded_asset($header_logo) }}" height="40">
            @else
                <img src="{{ static_asset('assets/img/Artistiqe_Logo_Full_Name 1.svg') }}" height="40">
            @endif
        </a>
    </div>
            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-9 col-lg-10 col-md-7 mx-auto py-lg-4">
                    ...
                    <div class="login-box">
                        ...
                        <div class="row no-gutters align-items-center login-row">
                            <!-- Left Side Image-->
                          <div class="col-lg-6 d-flex align-items-center justify-content-center login-left">
    <img src="{{ uploaded_asset(get_setting('customer_login_page_image')) }}"
         ...
         class="login-left-img">
                            ...
                            <!-- Right Side -->
                            <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center login-right">
