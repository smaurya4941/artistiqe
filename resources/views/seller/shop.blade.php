...
@section('panel_content')
    ...
    <div class="aiz-titlebar mt-2 mb-4">
      <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{ translate('Profile Settings')}}
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 h6">{{ translate('Profile Details') }}</h5>
        </div>
        <div class="card-body">
            <form class="" action="{{ route('seller.shop.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <label class="col-md-2 col-form-label">{{ translate( 'About Yourself') }}<span class="text-danger text-danger">*</span></label>
                    <div class="col-md-10">
