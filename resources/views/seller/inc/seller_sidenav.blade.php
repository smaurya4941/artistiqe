    ...
    <div class="aiz-sidebar left c-scrollbar">
        <div class="aiz-side-nav-logo-wrap">
            <div class="d-block text-center my-3">
                ...
                @else
                    <img class="mw-100" src="{{ static_asset('assets/img/Artistiqe_Logo_sd.png') }}" class="brand-icon"
                    alt="{{ get_setting('site_name') }}" <br>
                @endif
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Artworks') }}</span>
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.products') }}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Upload new Artwork') }}</span>
                            </a>
                        </li>
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('seller.product_bulk_upload.index') }}"
                                ...
                                <span class="aiz-side-nav-text">{{ translate('Artwork Bulk Upload') }}</span>
                            </a>
                        </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('seller.shop.index') }}"
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Profile Settings') }}</span>
                    </a>
                </li>
