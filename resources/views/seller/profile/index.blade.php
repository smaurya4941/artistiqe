...
<form action="{{ route('seller.profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="card">
        ...
        <div class="form-group row">
            <label class="col-md-2 col-form-label" for="description">{{ translate('About You / Shop Description') }}</label>
            <div class="col-md-10">
                <textarea name="description" id="description" rows="5" class="form-control"
    placeholder="{{ translate('Write something about yourself or your shop...') }}">{{ old('description', optional($user->shop)->description) }}</textarea>
...
<form action="{{ route('user.change.email') }}" method="POST">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-2">
                    <label>{{ translate('Your New Email') }}</label>
                </div>
                <div class="col-md-10">
...
<script type="text/javascript">
    $('.new-email-verification').on('click', function() {
        ...
        $.post('{{ route('user.email.update.verify.code') }}', {_token:'{{ csrf_token() }}', email: email}, function(data){
